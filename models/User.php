...
class User extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            // ['user_role_id', 'default', 'value' => self::ROLE_USER],
            // ['user_role_id', 'in', 'range' => [self::ROLE_USER, self::ROLE_STAFF, self::ROLE_ADMIN]],

            ['permissions', 'validatePermissions'],
            [['device_token', 'permissions'], 'safe'],
        ];
    }
    ...
    public function getUserDetailsByAccessToken($program_id,$access_token){
        $sql = "SELECT DISTINCT Userr.id AS user_id,
                       Userr.user_role_id,
                       Userr.username,
                       Userr.password_hash,
                       Userr.supervisor,
                ...
                WHERE Userr.device_token = '".$access_token."'
                    ...
                    //UserDetail.city_id,
                    //CASE WHEN Userr.is_owner_login = 1 THEN true ELSE false END AS is_owner,
                      //, Userr.asm_id
                      //echo $sql;exit;
